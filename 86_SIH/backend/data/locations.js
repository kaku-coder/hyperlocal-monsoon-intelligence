...
const locations = [
  ...
  // Balasore District
  {
    ...
    panchayats: ["Kuruda", "Haladipada", "Chhanpur", "Srikona"],
    ...
    metrics: {
      ...
      rainfall_24h_mm: 6.2,
      rainfall_15d_cumulative_mm: 48.0,
      rainfall_anomaly_percent: -8.0,
      soil_moisture_level: "Moderate",
      soil_moisture_fraction: 0.30,
      expected_rainfall_7d: 52.0,
      expected_rainfall_14d: 110.0,
      expected_rainfall_21d: 155.0,
      expected_rainfall_30d: 198.0,
      onset_probability: 0.78,
      break_probability: 0.45,
      heavy_rain_probability: 0.35,
      confidence: 0.80,
      dominant_risk: "MODERATE",
      risk_factor: "Moderate Dry Spell Risk in week 3"
    }
  },
  {
    ...
    district: "Balasore",
    block: "Jaleswar",
    panchayats: ["Sugo", "Kotasahi", "Rayaramchandrapur", "Paschimbad"],
    ...
    metrics: {
      ...
      rainfall_15d_cumulative_mm: 64.0,
      rainfall_anomaly_percent: 8.0,
      soil_moisture_level: "High",
      soil_moisture_fraction: 0.38,
      expected_rainfall_7d: 70.0,
      expected_rainfall_14d: 145.0,
      expected_rainfall_21d: 195.0,
      expected_rainfall_30d: 245.0,
      onset_probability: 0.85,
      break_probability: 0.25,
      heavy_rain_probability: 0.55,
      confidence: 0.82,
      dominant_risk: "LOW",
      risk_factor: "Favorable Onset with Adequate Surface Runoff"
    }
  },
  ...
  // Bhadrak District
  {
    ...
    district: "Bhadrak",
    block: "Bhadrak Sadar",
    panchayats: ["Arnapal", "Kharida", "Randia", "Banta"],
    ...
    metrics: {
      ...
      humidity_percent: 68.0,
      rainfall_24h_mm: 3.8,
      rainfall_15d_cumulative_mm: 39.0,
      rainfall_anomaly_percent: -19.0,
      soil_moisture_level: "Low",
      soil_moisture_fraction: 0.24,
      expected_rainfall_7d: 47.0,
      expected_rainfall_14d: 99.0,
      expected_rainfall_21d: 140.0,
      expected_rainfall_30d: 178.0,
      onset_probability: 0.74,
      break_probability: 0.62,
      heavy_rain_probability: 0.27,
      confidence: 0.78,
      dominant_risk: "HIGH",
      risk_factor: "Dry Spell Risk with Low Germination Moisture"
    }
  },
  {
    ...
    district: "Bhadrak",
    block: "Chandbali",
    panchayats: ["Motto", "Kandagaradi", "Aradi", "Bansada"],
    ...
    metrics: {
      ...
      rainfall_15d_cumulative_mm: 72.0,
      rainfall_anomaly_percent: 12.0,
      soil_moisture_level: "High",
      soil_moisture_fraction: 0.41,
      expected_rainfall_7d: 78.0,
      expected_rainfall_14d: 155.0,
      expected_rainfall_21d: 208.0,
      expected_rainfall_30d: 265.0,
      onset_probability: 0.86,
      break_probability: 0.24,
      heavy_rain_probability: 0.61,
      confidence: 0.83,
      dominant_risk: "HIGH",
      risk_factor: "High Heavy Rainfall & Waterlogging Probability"
    }
  },
  ...
  // Ganjam District (Southern Odisha)
  {
    ...
    state: "Odisha",
    district: "Ganjam",
    block: "Berhampur (Rangunia)",
    panchayats: ["Ankushpur", "Lathi", "Nimakhandi", "Golanthara"],
    ...
    metrics: {
      ...
      rainfall_24h_mm: 1.0,
      rainfall_15d_cumulative_mm: 34.0,
      rainfall_anomaly_percent: -22.0,
      soil_moisture_level: "Low",
      soil_moisture_fraction: 0.23,
      expected_rainfall_7d: 44.0,
      expected_rainfall_14d: 92.0,
      expected_rainfall_21d: 130.0,
      expected_rainfall_30d: 165.0,
      onset_probability: 0.73,
      break_probability: 0.64,
      heavy_rain_probability: 0.26,
      confidence: 0.79,
      dominant_risk: "HIGH",
      risk_factor: "Rainfall deficit during direct seedling emergence"
    }
  },
  ...
  // Mayurbhanj District (Northern Plateau)
  {
    ...
    district: "Mayurbhanj",
    block: "Baripada",
    panchayats: ["Pundal", "Sankhabhanga", "Manitri", "Badasahi"],
    ...
    metrics: {
      ...
      rainfall_24h_mm: 0.0,
      rainfall_15d_cumulative_mm: 25.0,
      rainfall_anomaly_percent: -36.0,
      soil_moisture_level: "Low",
      soil_moisture_fraction: 0.17,
      expected_rainfall_7d: 34.0,
      expected_rainfall_14d: 76.0,
      expected_rainfall_21d: 110.0,
      expected_rainfall_30d: 140.0,
      onset_probability: 0.66,
      break_probability: 0.74,
      heavy_rain_probability: 0.19,
      confidence: 0.77,
      dominant_risk: "VERY HIGH",
      risk_factor: "Severe Upland Soil Moisture Deficit"
    }
  },
  ...
  // Jajpur District
  {
    ...
    district: "Jajpur",
    block: "Jajpur Sadar",
    panchayats: ["Bari", "Binjharpur", "Dharmasala", "Sukinda"],
    ...
    metrics: {
      ...
      humidity_percent: 66.0,
      rainfall_24h_mm: 4.0,
      rainfall_15d_cumulative_mm: 36.0,
      rainfall_anomaly_percent: -20.0,
      soil_moisture_level: "Moderate",
      soil_moisture_fraction: 0.26,
      expected_rainfall_7d: 49.0,
      expected_rainfall_14d: 104.0,
      expected_rainfall_21d: 146.0,
      expected_rainfall_30d: 185.0,
      onset_probability: 0.75,
      break_probability: 0.59,
      heavy_rain_probability: 0.30,
      confidence: 0.78,
      dominant_risk: "MODERATE",
      risk_factor: "Intermittent dry periods requiring protective irrigation"
    }
  }
];
